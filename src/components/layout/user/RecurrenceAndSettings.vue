<template>
  <div class="min-h-full flex justify-center items-end mb-6 pb-6">
    <div>
      ...
      <div v-else class="bg-white shadow-md rounded-lg overflow-hidden overflow-x-auto overflow-y-auto mt-6">
        <p class="p-2">{{ $t('settingsRecursiveList') }}</p>
